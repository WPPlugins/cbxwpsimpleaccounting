...
function cbxaccounting_countChecked() {

    var limit = 1;
    var n = jQuery("input.cbacnt-cat-exinciteminput:checked").length;

    if (n == limit) {
        jQuery('input.cbacnt-cat-exinciteminput:not(:checked)').prop('disabled', true);
    }
    else {
        jQuery('input.cbacnt-cat-exinciteminput:not(:checked)').prop('disabled', false);
    }
...
(function($) {
    ...
    jQuery(document).ready(function($) {
        ...
        $("input.cbacnt-cat-exinciteminput:checkbox").click(function(event) {
            var limit = 1;
        ...
        $('#cbacnt-expinc-form').on('click', '.cbacnt-edit-exinc', function(event) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        //
						wp.hooks.doAction( 'cbxwpsimpleaccounting_incexp_edit_data', $form , response);
        ...
        $('#cbacnt-expinc-form').on('click', '.cbacnt-new-exinc', function() {
			...
			//js hook here
			wp.hooks.doAction( 'cbxwpsimpleaccounting_incexp_new_reset', $form );
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
						...
						wp.hooks.doAction( 'cbxwpsimpleaccounting_incexp_post_data', $form, response );
