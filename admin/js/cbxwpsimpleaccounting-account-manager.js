...
(function($) {
    ...
    $(document).ready(function($) {
        ...
        //var $accselection = $('.cbacnt-acc-type').val();
        ...
        $.each($all_acc_list, function(index, acc) {
            if ($.isEmptyObject(acc))
                return;
            if (acc.type == 'cash') {
                $('#cbacnt-expinc-acc-list').append('<li class="cbacnt-acc-exinc cbacnt-acc-inc cbacnt-acc-type-cash cbacnt-acc-type-cash-color' + (($accselection == 'bank') ? 'hidden' : '') + '">' + acc.title.replace(/\\/g, '') + ' <a data-accid="' + acc.id + '" class="cbacnt-edit-cbxacc" href="#">' + cbxwpsimpleaccounting.edit + '</a></li>');
            }
            else {
                $('#cbacnt-expinc-acc-list').append('<li class="cbacnt-acc-exinc cbacnt-acc-inc cbacnt-acc-type-bank cbacnt-acc-type-bank-color' + (($accselection == 'cash') ? 'hidden' : '') + '">' + acc.title.replace(/\\/g, '') + ' <a data-accid="' + acc.id + '" class="cbacnt-edit-cbxacc" href="#">' + cbxwpsimpleaccounting.edit + '</a></li>');
            }
        });

        //show hide extra fields for bank or cash based on account type
        $('.cbacnt-acc-type').change(function() {
            var $this = $(this);
            
            //$('input[name=cbacnt-acc-type-bottom][value=' + $this.val() + ']').prop('checked', true);
        ...
        //create new account
        $('#cbacnt-account-form').submit(function(evnt) {
            evnt.preventDefault();
            var $form = $(this);
        ...
        $('#cbacnt-account-form').on('click', '.cbacnt-new-acc, #cbacnt-edit-acc-cancel', function(event) {
        ...
        $('#cbxaccounting_accmanager').on('click', '.cbacnt-edit-cbxacc', function(event) {
            event.preventDefault();
