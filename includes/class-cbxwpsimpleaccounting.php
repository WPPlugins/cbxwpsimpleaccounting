...
class Cbxwpsimpleaccounting {
    ...
    private function define_admin_hooks() {
        ...
        //$this->loader->add_action('activated_plugin', $plugin_admin, 'cbxaccounting_activation_error', 10);//activate for testing only....search for 'cbxaccounting_activation_error' meta name in option table if error occurs.
