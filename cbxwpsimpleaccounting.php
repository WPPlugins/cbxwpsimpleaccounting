 ...
 *
 * @wordpress-plugin
 * Plugin Name:       CBX Accounting
 * Plugin URI:        http://codeboxr.com/product/cbx-accounting/
 * Description:       This plugin gives simple accounting solution to wordpress for SME businness
 * Version:           1.2.5
 * Author:            Codeboxr
...
defined('CBXWPSIMPLEACCOUNTING_PLUGIN_VERSION') or define( 'CBXWPSIMPLEACCOUNTING_PLUGIN_VERSION', '1.2.5' );
